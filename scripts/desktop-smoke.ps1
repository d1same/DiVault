...
try {
    ...
    if (-not $RemoteUrl) {
        $scriptResponse = Invoke-WebRequest -Uri 'http://127.0.0.1:3444/app.js?v=104' -TimeoutSec 5
        ...
        $styleResponse = Invoke-WebRequest -Uri 'http://127.0.0.1:3444/styles.css?v=104' -TimeoutSec 5
